...
resource "aws_autoscaling_group" "autoscaling_group" {
  name                      = "ASG_${aws_launch_configuration.autoscaling_launch_configuration.name}"
...
resource "aws_autoscaling_policy" "autoscaling_policy_increase_capacity" {
  name                   = "autoscaling_${aws_autoscaling_group.autoscaling_group.name}_policy_increase_capacity"
...
resource "aws_autoscaling_policy" "autoscaling_policy_decrease_capacity" {
  name                   = "autoscaling_${aws_autoscaling_group.autoscaling_group.name}_policy_decrease_capacity"
  scaling_adjustment     = -50
  adjustment_type        = "PercentChangeInCapacity"
  cooldown               = 300
  autoscaling_group_name = "${aws_autoscaling_group.autoscaling_group.name}"
...
resource "aws_cloudwatch_metric_alarm" "autoscaling_alarm_increase_capacity_threshold" {
  alarm_name          = "autoscaling_${aws_autoscaling_group.autoscaling_group.name}_policy_increase_capacity_threshold"
...
resource "aws_cloudwatch_metric_alarm" "autoscaling_alarm_decrease_capacity_threshold" {
  alarm_name          = "autoscaling_${aws_autoscaling_group.autoscaling_group.name}_policy_decrease_capacity_threshold"
