...
| additional_security_group_ids | List of additional security groups to assign to the instances in addition to the security group created by this module. | `<list>` | no |
